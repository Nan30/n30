//Closing a Ticket....
//alert("XSS");
var statusVal = getClosedLabel();assignValue('Cases','6b28c32dddd03edfaf6944840c01aa04e612657a51fd5fbe',encodeURIComponent(statusVal),'Status');jQuery('status_val').val(statusVal);
