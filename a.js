//Closing a Ticket...
alert("XSS");
//var statusVal = getClosedLabel();assignValue('Cases','8d5bbe2d9655b5203283e5ff45aa79e27cc50d48844902f0',encodeURIComponent(statusVal),'Status');jQuery('status_val').val(statusVal);
